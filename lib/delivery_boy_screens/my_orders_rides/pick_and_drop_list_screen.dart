...
class PickAndDropListScreen extends StatefulWidget {
  const PickAndDropListScreen({super.key});

  @override
  State<PickAndDropListScreen> createState() => _PickAndDropListScreenState();
}

class _PickAndDropListScreenState extends State<PickAndDropListScreen> {
  @override
  void initState() {
    // TODO: implement initState
    context.read<MyOrderRidesCubit>().fecthRideList('pickupanddrop');
    super.initState();
  }
