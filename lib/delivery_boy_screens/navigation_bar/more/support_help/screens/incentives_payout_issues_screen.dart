...
class PayoutIssueScreen extends StatefulWidget {
  const PayoutIssueScreen({super.key});

  @override
  State<PayoutIssueScreen> createState() => _PayoutIssueScreenState();
}

class _PayoutIssueScreenState extends State<PayoutIssueScreen> {
  final incentiveKey = GlobalKey<FormState>();
  ...
  Future<void> getImage(
    ...
    if (pickedDocument == null) {
      ...
      //     setState(() {
      //       attachOne = pickedDocument;
      //       uploadAttachOne = request.data['data']['image_path'];
      //     });
      //     print("attcHH $uploadAttachOne");
      //   }
      // }
                    ...
                    return Padding(
                        ...
                        child: SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              final FormState? form = incentiveKey.currentState;
                              if (form!.validate()) {
                                print("form valid");
                                context.read<SupportHelpBloc>().add(
                                    IncentivesnPayoutIssueEvent(
                                ...
                                //       vehicleNumber: bikeNumberController.text
                                //           .toString(),
                                //       vehicleValidity: bikeValidityController
                                //           .text
                                //           .toString(),
                                //       drivingLicenseNumber:
                                //           drivingController.text.toString(),
                                //       drivingLicensePhoto:
                                //           uploadLicenseImagepic!,
                                //       vehiclePhoto: uploadBikeImagepic!,
                                //       vehicleName:
                                //           bikeNameController.text.toString(),
                                //     ));
