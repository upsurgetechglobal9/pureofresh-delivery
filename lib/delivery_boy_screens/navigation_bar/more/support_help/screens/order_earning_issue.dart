...
class OrderEarningIssueScreen extends StatefulWidget {
  const OrderEarningIssueScreen({super.key});

  @override
  State<OrderEarningIssueScreen> createState() =>
      _OrderEarningIssueScreenState();
}

class _OrderEarningIssueScreenState extends State<OrderEarningIssueScreen> {
  final orderEarningsKey = GlobalKey<FormState>();
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<SupportHelpBloc, SupportHelpState>(
      listener: (context, state) {
        ...
        if (state is OrderIssueSuccessState) {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    DeliveryBoyTextFormField(
                        ...
                        isDense: true,
                        hint: ConvertText.getTitle("Order Id"),
                        hintStyle: GoogleFonts.manrope(
                            color: Colors.grey, fontSize: 12),
                              ...
                              child: ElevatedButton(
                                ...
                                onPressed: () {
                                  final FormState? form =
                                      orderEarningsKey.currentState;
                                  if (form!.validate()) {
                                    print("form valid");

                                    context.read<SupportHelpBloc>().add(
                                        OrderEarningIssueEvent(
